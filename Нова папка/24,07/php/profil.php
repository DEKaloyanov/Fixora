...
<main>
    ...
    <div class="main-buttons">
        <button class="filter-btn main-btn active" data-filter="all">Всички обяви</button>
        <button class="filter-btn main-btn" data-filter="add">Добави обява</button>
    </div>
    
    <div class="sub-buttons-container">
        <div class="job-sub-buttons all">
            <button class="filter-btn sub-btn" data-filter="offer">Предлагам работа</button>
            <button class="filter-btn sub-btn" data-filter="seek">Търся работа</button>
        </div>
        
        <div class="job-sub-buttons add">
            <button class="filter-btn sub-btn" id="btn-add-offer">Добави работа</button>
            <button class="filter-btn sub-btn" id="btn-add-seek">Добави екип</button>
        </div>
    </div>
</div>
