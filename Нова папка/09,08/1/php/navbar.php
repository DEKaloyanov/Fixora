...
<header>
  ...
  <nav>
    <ul class="navbar">
      ...
      <li><a href="/Fixora/chat.php" class="<?= basename($_SERVER['PHP_SELF']) == 'chat.php' ? 'active' : '' ?>">Чат</a>
      </li>
      <li>
  ...
  <a href="/Fixora/php/favorites.php"
     id="favorites-link"
     class="<?= basename($_SERVER['PHP_SELF']) == 'favorites.php' ? 'active' : '' ?>">Любими</a>
</li>
      ...
      <?php if (isset($_SESSION['user'])): ?>
        <li class="dropdown">
          <a href="/Fixora/php/profil.php"
            class="button dropdown-toggle"><?= htmlspecialchars($_SESSION['user']['username']) ?></a>
