...
$user = $_SESSION['user'];
$userId = (int) $user['id'];
// за навигацията: коя страница е активна
        ...
        <form action="update_profile.php" method="POST" enctype="multipart/form-data" class="profile-form">
            ...
            <div class="field-group">
                ...
                <div class="profile-pic-wrapper" id="cropperArea" data-has-image="<?= $hasRealImage ?>">
                    ...
                    <label for="profile_image" id="profilePicLabel" class="profile-pic-label"
                        title="Кликни за избор на снимка">
            ...
            <div class="form-grid">
                ...
                <div class="field-group">
                    ...
                    <input class="input" type="text" name="familiq" value="<?= htmlspecialchars($user['familiq']) ?>"
                        required>
                </div>
