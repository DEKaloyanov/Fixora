...
`;
                ...
                // Инициализация на специфичните полета за търсене на екип
                if (type === 'seek') {
                ...
                // ====== НОВО: Image Manager (само за "offer") ======
                ...
                input.addEventListener('change', (e) => {
                    ...
                    renderGrid();
                    input.value = ''; // позволява повторен избор на същите файлове
                });

                // Позволи drop на нови файлове в зоната
            ...
            `;
                        ...
                        tile.addEventListener('dragstart', (e) => { dragSrc = idx; e.dataTransfer.effectAllowed = 'move'; });
                ...
                // При submit: подаваме файловете в подредения от нас ред + корица
                form.addEventListener('submit', () => {
                    if (files.length > 0) {
                        const dt = new DataTransfer();
                        files.forEach(f => dt.items.add(f)); // редът от UI
